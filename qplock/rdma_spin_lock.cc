...
RdmaSpinLock::RdmaSpinLock(MemoryPool::Peer self,
...
bool RdmaSpinLock::IsLocked(){
    return *std::to_address(lock_) != kUnlocked;
}
...
void RdmaSpinLock::Unlock() { pool_.Write<uint64_t>(lock_, 0, /*prealloc=*/local_); }
